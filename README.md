...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/policy_sentry-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12839&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/policy_sentry-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `policy_sentry` can be installed with:

```
conda install policy_sentry
```

It is possible to list all of the versions of `policy_sentry` available on your platform with:
